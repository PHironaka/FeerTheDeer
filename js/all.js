...
CountdownTimer.prototype={
 initialize:function(elm,tl,mes) {
  ...
  if( ( this.tl - today ) > 0 ){
   timer += '<span class="number-wrapper"><div class="caption">DAYS</div><span class="number day">'+day+'</span></span>';
   timer += '<span class="number-wrapper"><div class="caption">HOURS</div><span class="number hour">'+hour+'</span></span>';
   timer += '<span class="number-wrapper"><div class="caption">MINS</div><span class="number min">'+this.addZero(min)+'</span></span><span class="number-wrapper"><div class="caption">SECS</div><span class="number sec">'+this.addZero(sec)+'</span></span>';
...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2015/05/02 00:00:00');
...
$(function(){SyntaxHighlighter.all()});$(window).load(function(){$(".flexslider").flexslider({animation:"slide",start:function(a){$("body").removeClass("loading")}})});
